        ...
        <View style={styles.Container}>
            ...
            <View style={styles.SubContainer}>
                <TextInput
                    ...
                    value={GallonsFormatMethods.getPaintEfficiency(data)}
                    onChangeText={(value) => GallonsFormatMethods.setPaintEfficiency(setData, value)}
                />
                <View style={styles.Button}>
                    <TouchableOpacity
                        onPress={() => {
                            GallonsFormatMethods.setPaintEfficiency(setData, '0')
                        }}
                    >
