...
export default function CoatAmountInput({ index_i, index_j }) {
    ...
    function decreaseDuplicates() {
        ...
        if (amount < 1)
            amount = 1
        LitersFormatMethods.setCoatAmount(setData, String(amount))
    }

    function increaseDuplicates() {
        const amount = Number(LitersFormatMethods.getCoatAmount(data)) + 1
        LitersFormatMethods.setCoatAmount(setData, String(amount))
    }
        ...
        <View style={styles.Container}>
            ...
            <View style={styles.SubContainer}>
                <TextInput
                    ...
                    value={LitersFormatMethods.getCoatAmount(data)}
                    onChangeText={(value) => LitersFormatMethods.setCoatAmount(setData, value)}
                />
